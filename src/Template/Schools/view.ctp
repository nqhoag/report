...
<div class="schools view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Sodienthoai') ?></th>
        ...
        <tr>
            <th scope="row"><?= __('Caphoc Id') ?></th>
            <td><?= $this->Number->format($school->caphoc_id) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Loaitruong Id') ?></th>
            <td><?= $this->Number->format($school->loaitruong_id) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Namthanhlap') ?></th>
