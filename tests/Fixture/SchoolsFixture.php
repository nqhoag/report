...
class SchoolsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'caphoc_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '0: mẫu giáo, mầm non. 1: cấp 1. 2: cấp 2. 3: cấp 3. 4: bổ túc , GDTX', 'precision' => null, 'autoIncrement' => null],
        'loaitruong_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
